...
describe('App reducer', () => {
  ...
  describe('SET DATABASE REQUESTS', () => {
    ...
    it('should set database requests', () => {
      expect(appReducer(state, action).dataResults['Database Requests']).toEqual('helloworld')
    })
  })
  ...
  describe('SET DATA POINTS', () => {
    ...
    it('should set database requests', () => {
      expect(appReducer(state, action).dataResults['Data Points']).toEqual('helloworld')
    })
  })
  ...
  describe('SET NESTING DEPTH', () => {
    ...
    it('should set nesting depth', () => {
      expect(appReducer(state, action).dataResults['Nesting Depth']).toEqual('helloworld')
    })
  })
  ...
  describe('SET EFFECTIVE RUNTIME', () => {
    ...
    it('should set effective runtime', () => {
      expect(appReducer(state, action).dataResults['Effective Runtime']).toEqual('helloworld')
    })
  })
  ...
  describe('SET RESOLVER NUM', () => {
    ...
    it('should set resolver num', () => {
      expect(appReducer(state, action).dataVis.resolverNum).toEqual('helloworld')
    })
  })
  ...
  describe('SET RESOLVER NAMES', () => {
    ...
    it('should set resolver names', () => {
      expect(appReducer(state, action).dataVis.resolverNames).toEqual('helloworld')
    })
  })
})